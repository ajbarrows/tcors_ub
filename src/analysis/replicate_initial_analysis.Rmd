...
when adjusting for baseline CPD, each VLNC group smoked significantly less at Week 12 compared to the normal nicotine group, but not differently from one another. In particular:
